...
# project root = TerraSense/
PROJECT_ROOT = os.path.abspath(os.path.join(SCRIPT_DIR, "..", ".."))

# models + data follow same layout as eval_config.yaml
MODELS_ROOT = os.path.join(PROJECT_ROOT, "models")
DATA_ROOT   = os.path.join(PROJECT_ROOT, "data")

TEACHER_DIR = os.path.join(MODELS_ROOT, "prithvi_teacher")
TEACHER_CKPT = os.path.join(TEACHER_DIR, "Prithvi_EO_V2_300M_TL.pt")
TEACHER_CONFIG = os.path.join(TEACHER_DIR, "config.json")

STUDENT_CKPT = os.path.join(MODELS_ROOT, "ckpts_regime", "student_regime_ep10.pt")
